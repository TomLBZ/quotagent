...
from quotagent.kernel.canon import canonical_json, digest
...
from quotagent.services import negotiation as negotiation_module
from quotagent.services.approval import (AgentCannotApprove, ApprovalError, ApprovalRequired, ApprovalService,
                                 UnknownApproval)
from quotagent.services.costmodel import CostLibrary, CostModelService, PrivateAccessDenied
from quotagent.services.negotiation import (ConcessionBelowFloor, ConcessionLimitExceeded, ConcessionOutOfBand,
...
def _module_source() -> tuple[Path, str]:
    ...
    return _impl_source(negotiation_module)
