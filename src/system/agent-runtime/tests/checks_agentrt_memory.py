...
def check() -> list[Assertion]:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        real_copy = probe / 'src' / 'system' / 'agent-runtime' / 'tests' / 'checks_agentrt_memory.py'                 # 真源码路径形状
        derived_copy = probe / 'tmp' / 'usreq-clean' / 'src' / 'system' / 'agent-runtime' / 'tests' / 'checks_agentrt_memory.py'
