...
**位置（本批迁移）**：实体在 `src/system/webui/tools/refresh-ui-snapshots.py`；旧位置 `tools/refresh-ui-snapshots.py` 只剩**薄转发**
...
用法::
    ...
    python3 src/system/webui/tools/refresh-ui-snapshots.py                       # 两个视角，默认目录
    python3 src/system/webui/tools/refresh-ui-snapshots.py --views contractor
    python3 src/system/webui/tools/refresh-ui-snapshots.py --views contractor,supplier --shared-dir tmp/ui-shared
"""
