...
> **本文件的位置**：就是 27 §2.1 的**标准位置**（`src/system/qa-runner/requirements/README.md`）—— `T-318` 期间它曾在
> `docs/work/plugin-requirements-system-qa-runner.md`，`T-321` 用 `git mv` 归位（**内容逐字节不变**；逐条 sha256 与归位台账见映射表 §4.2 与
