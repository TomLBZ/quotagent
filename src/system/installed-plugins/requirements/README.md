...
Acceptance is shared with `node src/system/plugin-studio/tests/evolution.mjs` and the native GUI journey in that plugin. Local native and real-model GUI evidence is recorded in `docs/work/evidence/EV-G7-NATIVE-EVOLUTION.md`; the public release replay remains an integration step.
