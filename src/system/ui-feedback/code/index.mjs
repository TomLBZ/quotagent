/**
 * 进树插件入口：`system/ui-feedback`（**本批 `EV-178` 的真实承载**）。
 *
 * 做什么：把**已随实体搬迁落进本目录 `code/`** 的那一份实现（`./ui-feedback.mjs`）的公开面**重导出**
 ...
 */
import * as impl from './ui-feedback.mjs'

export * from './ui-feedback.mjs'
