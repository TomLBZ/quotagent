...
> **本文件的位置**：27 §2.1 的标准形态是 `src/domain/clarify/requirements/README.md`；本插件**尚无插件目录**
> （迁移计划阶段 2–4 才建），本批（`T-318`）按 27 §2.4 的口径把文档落在 `docs/work/plugin-requirements-domain-clarify.md`
