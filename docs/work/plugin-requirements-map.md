...
| `system/pipeline-view` | FR-UX-005 | `host/modules/pipeline-view.mjs`、`src/system/webui/tools/refresh-ui-snapshots.py` | done | `pipeline-view`(7/7) · `pipeline-route` · `ac AC-UI-002` · `req=src/system/pipeline-view/requirements/README.md` |
