/**
 * 薄重导（迁移阶段 4.2/5，本批 `EV-177`）：实体已搬到 `src/system/kernel/code/ledger-view.mjs`。
 *
 ...
 * 里的 `../lib/ledger-view.mjs` 一行未改（本文件不含任何实现）。
 */
export * from '../../src/system/kernel/code/ledger-view.mjs'
