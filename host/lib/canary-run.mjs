/**
 * 薄重导（迁移阶段 4.2/5，本批 `EV-177`）：实体已搬到 `src/system/canary/code/canary-run.mjs`。
 *
 ...
 * 里的 `../lib/canary-run.mjs` 一行未改（本文件不含任何实现）。
 */
export * from '../../src/system/canary/code/canary-run.mjs'
