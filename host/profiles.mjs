...
export const PROFILES = {
  ...
  'webui': {
    ...
    realm: 'contractor:con-B',
    ledger: 'ledger-contractor.jsonl',
    modules: ['config', 'projection', 'webui', 'timeline', 'canary', 'audit-hook', 'governor', 'observability', 'price-history', 'evidence-summary', 'ops-view', 'evolve-journal', 'supplier-scorecard', 'approval-digest', 'retention-view', 'pipeline-view', 'admin-guard', 'admin-view', 'plugin-market', 'user-plugin-manager', 'config-view', 'mail-view', 'bid-heuristics'],
    sidecar: 'read-only',
    config: {
