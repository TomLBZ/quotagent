...
用法::
    ...
    python3 tools/ui-seed-pipeline.py                                  # 两侧，默认 tmp/ui-shared
    python3 tools/ui-seed-pipeline.py --shared-dir tmp/t261-seed
    python3 tools/ui-seed-pipeline.py --sides contractor --now 2026-09-21T12:00:00Z
